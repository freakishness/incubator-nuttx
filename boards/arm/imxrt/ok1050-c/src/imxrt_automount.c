/****************************************************************************
 * boards/arm/imxrt/ok1050-c/src/imxrt_automount.c
 *
...
static const struct imxrt_automount_config_s g_sdhc_config =
{
  .lower        =
    {
    .fstype     = CONFIG_OK1050_C_SDHC_AUTOMOUNT_FSTYPE,
    .blockdev   = CONFIG_OK1050_C_SDHC_AUTOMOUNT_BLKDEV,
    .mountpoint = CONFIG_OK1050_C_SDHC_AUTOMOUNT_MOUNTPOINT,
    .ddelay     = MSEC2TICK(CONFIG_OK1050_C_SDHC_AUTOMOUNT_DDELAY),
    .udelay     = MSEC2TICK(CONFIG_OK1050_C_SDHC_AUTOMOUNT_UDELAY),
