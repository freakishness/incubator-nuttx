/****************************************************************************
 * boards/arm/imxrt/ok1050-c/src/imxrt_flexspi_nor_flash.c
 *
...
#if defined(CONFIG_OK1050_C_HYPER_FLASH)
        ...
        .mem_config =
          {
            ...
            .read_sample_clksrc =
                      FLASH_READ_SAMPLE_CLK_EXT_INPUT_FROM_DQSPAD,
            .cs_hold_time = 3u,
            .cs_setup_time = 3u,
            ...
            .lookup_table =
              {
                  ...
                  FLEXSPI_LUT_SEQ(CMD_DDR, FLEXSPI_8PAD, 0xa0,
                                  RADDR_DDR, FLEXSPI_8PAD, 0x18),
                  FLEXSPI_LUT_SEQ(CADDR_DDR, FLEXSPI_8PAD, 0x10,
                                  DUMMY_DDR, FLEXSPI_8PAD, 0x06),
                  FLEXSPI_LUT_SEQ(READ_DDR, FLEXSPI_8PAD, 0x04,
...
#elif defined(CONFIG_OK1050_C_QSPI_FLASH)
locate_data(".boot_hdr.conf")
const struct flexspi_nor_config_s g_flash_config =
  {
    .mem_config =
        ...
        .lookup_table =
          {
            ...
            [1 * 4] = FLEXSPI_LUT_SEQ(CMD_SDR, FLEXSPI_1PAD, 0x05,
                                      READ_SDR, FLEXSPI_1PAD, 0x04),

            /* Write Enable */

            [3 * 4] = FLEXSPI_LUT_SEQ(CMD_SDR, FLEXSPI_1PAD, 0x06,
                                      STOP, 0, 0),

            /* Write status */

            [4 * 4] = FLEXSPI_LUT_SEQ(CMD_SDR, FLEXSPI_1PAD, 0x01,
                                      WRITE_SDR, FLEXSPI_1PAD, 0x2),
          },
      },
